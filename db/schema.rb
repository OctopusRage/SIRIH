...
ActiveRecord::Schema.define(version: 20170612001720) do
  ...
  create_table "inpatient_day_rooms", force: :cascade do |t|
    t.date "period"
    t.integer "total"
    t.string "room_code"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["room_code"], name: "index_inpatient_day_rooms_on_room_code"
  end

  create_table "inpatient_days", force: :cascade do |t|
    t.date "period"
    t.integer "total"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["period"], name: "index_inpatient_days_on_period", unique: true
  end
